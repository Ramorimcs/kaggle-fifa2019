...
#TRATAMENTO DE ATRIBUTOS DIFERENTES DE FLOAT64 E INT64
df.dtypes
#localidando atributos diferentes de float64 e int64
df.dtypes[(x not in ['int64', 'float64'] for x in df.dtypes)]

#TRATAMENTO DA ALTURA (HEIGHT - PÉS'POLEGADAS PARA CM) DOS JOGADORES
#transformando 5'7 (5 pés e 7 polegadas) em [5,7] (lista)
...
#TRATAMENTO DO PESO DOS JOGADORES
df['Weight']
